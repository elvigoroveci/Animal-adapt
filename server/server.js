...
const express = require("express"); //denis
app.use(express.static("public")); //denis
//denis
app.get("/Animal-adapt/server/Animals", (req, res) => {
  const imagePath = `./server/Animals/${req.params.imageName}`;
